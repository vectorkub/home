  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-6">
      <div className="card w-full max-w-xl p-8 text-center">
        ...
        <h1 className="mt-4 text-3xl font-semibold text-white">Test Page</h1>
        ...
        <div className="mt-6 grid grid-cols-2 gap-3 text-xs text-white/60">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-3">Dark theme active</div>
          <div className="rounded-2xl border border-white/10 bg-white/5 p-3">Components rendering</div>
        </div>
      </div>
    </div>
  )
