...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen">
          ...
          <AnimatedSection>
            <div className="max-w-3xl space-y-6">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <Link
                  href="/contact"
                  className="rounded-full border border-white/20 px-5 py-2.5 text-sm font-semibold text-white hover:border-white/40 hover:bg-white/5"
                >
                  Talk to our team
                </Link>
              </div>
      ...
      <section className="shell py-16">
        <div className="card relative overflow-hidden border-white/10 p-10">
          ...
          <div className="relative grid gap-10 lg:grid-cols-[1.2fr_1fr]">
            <div className="space-y-4">
              ...
              <h2 className="text-3xl font-bold leading-tight text-white">Embedded product squads</h2>
      ...
      <section className="shell pb-20 pt-10">
        <div className="flex flex-col items-center gap-4 rounded-[28px] border border-white/10 bg-gradient-to-br from-white/[0.04] via-white/[0.02] to-transparent px-8 py-10 text-center">
